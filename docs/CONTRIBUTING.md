...
GitHub provides additional document on [forking a repository][forks] and [creating a pull
...
We follow the conventions on [Conventional
Commits: How to Write a Better Git Commit Message][git-commit].
...
idea you'd like to discuss, open a discussion.
...
[git-commit]: https://tenthirtyam.org/dispatches/2026/03/22/conventional-commits-how-to-write-a-better-git-commit-message/
